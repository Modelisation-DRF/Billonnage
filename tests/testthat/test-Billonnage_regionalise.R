test_that("Test de la fonction ABCD_DHP_regio() avec DHP", {
  ...
  expect_no_error(ABCD_DHP_regio(data=fic_intrant, type="DHP"))
...
test_that("Test de la fonction ABCD_DHP_regio() avec ABCD", {
  ...
  expect_no_error(ABCD_DHP_regio(data=fic_intrant, type="ABCD"))
